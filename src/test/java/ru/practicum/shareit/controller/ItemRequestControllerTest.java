...
public class ItemRequestControllerTest {
    ...
    void setUp() {
        ...
        itemRequestDtoInput = new ItemRequestDto(1, "Item Request");
    ...
    void readAllRequestorRequestsTest() {
        Mockito.when(itemRequestService.getAllByRequestor(1L))
        ...
        Mockito.verify(itemRequestService).getAllByRequestor(1L);
    }

    @Test
    @SneakyThrows
    void readAllOtherUsersRequestsTest() {
        Mockito.when(itemRequestService.getAllUsersRequests(2L, pageable))
                .thenReturn(Collections.singletonList(itemRequestDtoOutput));
        ...
        Mockito.verify(itemRequestService).getAllUsersRequests(2L, pageable);
    }

    @Test
    @SneakyThrows
    void readTest() {
        Mockito.when(itemRequestService.getById(1L, 1L)).thenReturn(itemRequestDtoOutput);
        ...
        Mockito.verify(itemRequestService).getById(1, 1);
    }
}