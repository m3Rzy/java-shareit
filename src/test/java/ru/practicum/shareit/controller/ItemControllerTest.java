...
public class ItemControllerTest {
    ...
    ItemDtoRequest itemDtoWithRequestId;
    ItemDtoComment itemDtoWithComments1;
    ItemDtoComment itemDtoWithComments2;
    ...
    @SneakyThrows
    void readTest() {
        Mockito.when(itemService.getById(1L, 1L)).thenReturn(itemDtoWithComments1);
        ...
        Mockito.verify(itemService).getById(1, 1);
    }

    @Test
    @SneakyThrows
    void readAllTest() {
        itemDtoWithComments2 = new ItemDtoComment(2, "Item2",
                "Item2 Description", true, null, null, new ArrayList<>());

        Mockito.when(itemService.getAll(1L, pageable))
        ...
        Mockito.verify(itemService).getAll(1L, pageable);
    }
    ...
    void createComment_whenCommentValid_thenStatus200AndReturnedComment() {
        ...
        Mockito.when(itemService.comment(Mockito.anyLong(), Mockito.any(), Mockito.anyLong()))
        ...
        Mockito.verify(itemService).comment(Mockito.anyLong(), Mockito.any(), Mockito.anyLong());
    ...
    void createComment_whenTextBlank_thenStatus400() {
        ...
        Mockito.verify(itemService, Mockito.never())
                .comment(Mockito.anyLong(), Mockito.any(), Mockito.anyLong());
    }
