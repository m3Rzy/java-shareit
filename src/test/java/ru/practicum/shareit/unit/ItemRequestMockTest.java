...
public class ItemRequestMockTest {
    @Mock
    ...
    User user1;
    User user2;
    ItemRequestDto itemRequestDtoInput1;
    ItemRequestDto itemRequestDtoInput2;
    ...
    void setUp() {
        ...
        itemRequestDtoInput1 = new ItemRequestDto(1, "I need an item1");
        itemRequest1 = ItemRequestMapper.mapToItemRequest(itemRequestDtoInput1, user2, LocalDateTime.now());

        itemRequestDtoInput2 = new ItemRequestDto(2, "something with description");
    ...
    void readAllOtherUsersRequests_whenAllIsOk_thenReturnedRequests() {
        ...
        List<ItemRequestDtoOutput> otherUsersRequests = new ArrayList<>(itemRequestService
                .getAllUsersRequests(1, pageable));
    ...
    void read_whenAllIsOk_thenReturnedRequest() {
        ...
        ItemRequestDtoOutput returnedRequest = itemRequestService.getById(2, 1);
